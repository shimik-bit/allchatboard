...
export const metadata: Metadata = {
  ...
  title: {
    default: 'TaskFlow AI - הפכו צ׳אטים של וואטסאפ ללוחות מנוהלים',
  ...
  keywords: ['WhatsApp CRM', 'TaskFlow AI', 'AllChat', 'ניהול וואטסאפ', 'CRM ישראלי', 'AI WhatsApp', 'לוחות נתונים', 'אוטומציה עסקית'],
  ...
  openGraph: {
    ...
    title: 'TaskFlow AI - הפכו צ׳אטים של וואטסאפ ללוחות מנוהלים',
  ...
  twitter: {
    ...
    title: 'TaskFlow AI - WhatsApp Business Management',
