...
export const en: LocaleDictionary = {
  ...
  groupguard: {
    ...
    groups: {
      ...
      notify_admins_block: {
        title: 'Configure admin tagging when bot is not admin',
        ...
        message_label: 'Tag message',
        message_placeholder: 'Hi {admins}, spam received from {user}. Please handle.',
      },
    },
    scan_modal: {
      ...
      group_clean_message: 'None of the members appear in the global spammer blocklist.',
      ...
      done_subtitle_failures: '{success} removed, {failed} failed',
    ...
    log: {
      ...
      date: 'Date',
      trigger_ai: 'AI',
      trigger_manual_report: 'Manual report',
      trigger_phone_prefix: 'Blocked prefix',
      trigger_global_blocklist: 'Global blocklist',
