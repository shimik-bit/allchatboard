 ...
 * sendMessage / sendPhoto / getFile come in Phase 2.
 *
 ...
 * The secret is sent back in the X-Telegram-Bot-Api-Secret-Token header
 * so the receiver can verify the call really came from Telegram.
 */
...
/**
 * Removes the webhook. Used when deleting a bot or marking it inactive.
 */
